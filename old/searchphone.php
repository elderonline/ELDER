...
function process_form(){
	$searchPhoneQuery = "SELECT phoneDescription, phoneRepresentation FROM phone WHERE phoneDescription LIKE '%" . 
		mysql_real_escape_string($_POST['phoneDescription']) . "%'";
	if($_POST['phoneSymbol']){
		$searchPhoneQuery .=  " AND phoneRepresentation = '" . $_POST['phoneSymbol'] ."'";
	}
	...
	while ($row = mysql_fetch_array($result, MYSQL_BOTH)) {
		echo "\t<tr>\n";
			echo "\t\t<td>".$row['phoneRepresentation'].";</td>\n";
