...
<?php 
  ...
  <div id="content">
    ...
    <p>Welcome to the Uniform Server defualt start page. This page and every other file are being served from the main server root folder, "/www/". <br /> Additional support for 5-Nano can be found on the <a target="_1" href="http://wiki.uniformserver.com/index.php/Category:Uniform_Server_5.0-Nano">Wiki</a>.</p>
    <p>&nbsp;</p>
